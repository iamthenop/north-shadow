...
subtitle: "Part III: Protocol Is Not an Operating Model"
date: 2026-03-19
...
# Part III: Protocol Is Not an Operating Model
...
It is the difference between installing a robot on a factory floor and automating the entire assembly line.

A robot may perform one task perfectly.

The system around it still determines whether production succeeds.
